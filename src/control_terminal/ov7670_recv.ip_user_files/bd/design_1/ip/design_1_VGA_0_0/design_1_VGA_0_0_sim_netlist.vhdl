...
-- Date        : Tue Mar 21 13:35:33 2023
-- Host        : LAPTOP-83DSLEDJ running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/vivado_tut/ECE532_Project/OV7670-master_compress/OV7670-master/OV7670-master/OV7670/ov7670.srcs/sources_1/bd/design_1/ip/design_1_VGA_0_0/design_1_VGA_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_VGA_0_0_VGA is
  ...
  attribute SOFT_HLUTNM of \vCounter[8]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of vga_hsync_temp_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of vga_vsync_temp_i_1 : label is "soft_lutpair5";
begin
...
vga_hsync_temp_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => hCounter(8),
      I1 => hCounter(9),
      I2 => vga_hsync_temp_i_2_n_0,
      I3 => hCounter(5),
      I4 => hCounter(6),
      I5 => hCounter(7),
      O => vga_hsync_temp_i_1_n_0
    );
vga_hsync_temp_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0001FFFF"
    )
        port map (
...
vga_vsync_temp_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
      ...
      I1 => vCounter(2),
      I2 => vCounter(3),
      I3 => vga_vsync_temp_i_2_n_0,
      O => vga_vsync_temp_i_1_n_0
    );
vga_vsync_temp_i_2: unisim.vcomponents.LUT6
    generic map(
...
entity design_1_VGA_0_0 is
  ...
  attribute X_CORE_INFO of design_1_VGA_0_0 : entity is "VGA,Vivado 2018.3";
